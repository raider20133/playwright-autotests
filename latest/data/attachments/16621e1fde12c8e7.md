...
- Name: tests/api/leave.spec.ts >> Leave requests API >> known bugs >> an unknown leave type should be a 400, not a 500
- Location: tests/api/leave.spec.ts:80:9

# Error details

```
Error: POST https://managmenttool.onrender.com/api/leave → 500 {"message":"Database error creating leave request","error":"new row for relation \"leave_requests\" violates check constraint \"leave_requests_type_check\""}
