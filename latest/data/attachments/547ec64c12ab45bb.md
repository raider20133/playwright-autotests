...
- Name: tests/ui/tasks.spec.ts >> Checklist >> a paid task shows its price in USD
- Location: tests/ui/tasks.spec.ts:24:9

# Error details

```
Error: DELETE https://managmenttool.onrender.com/api/users/me → 500 {"error":"Authentication timed out"}
      ...
      - generic [ref=e92]:
        - list [ref=e93]:
          - listitem [ref=e94]:
            ...
            - generic [ref=e99]:
              - generic [ref=e100]: QA ui paid muifqe9w2p07
